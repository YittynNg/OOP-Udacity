...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):  # child attribute
        ...
        self.p = prob    # child attribute
        self.n = size    # child attribute
        ...
        Distribution.__init__(self, self.calculate_mean(), self.calculate_stdev())   # parent attribute
    ...
    def __add__(self, other):
        ...
        result = Binomial()   # instantiate new object
        result.p = self.p     # store value for new object
        result.n = self.n + other.n   # store value for new object
        result.calculate_mean()   # store value for new object
        result.calculate_stdev()   # store value for new object
